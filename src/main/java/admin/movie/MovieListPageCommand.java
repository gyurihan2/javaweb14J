...
public class MovieListPageCommand implements AdminInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 상영관 상영 시작일
		String startDate = request.getParameter("startDate") == null ? "1900-01-01" :  request.getParameter("startDate");
		
		int pag = request.getParameter("pag") == null ? 1 : Integer.parseInt(request.getParameter("pag"));
		int pageSize = request.getParameter("pageSize") == null ? 5 : Integer.parseInt(request.getParameter("pageSize"));
		int totRecCnt = dao.getListCnt(startDate);
		...
		vos = dao.getMovieList(startIndexNo,pageSize,startDate);
