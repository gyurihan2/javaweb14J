...
<div class="container">
	<h3>닉네임 체크폼</h3>
  <form name="childForm" method="post" action="${ctp}/SignUpNickNameChk.mem">
	  <c:if test="${res == 1}">
	    <h4><font color="blue"><b>${nickName}</b></font>는 사용 가능합니다.</h4>
	    <p>
	  ...
	  <c:if test="${res != 1}">
	    <h4><font color="blue"><b>${mid}</b></font>는 이미 사용중인 닉네임입니다.</h4>
	    	<p>
	    	  <input type="text" name="nickName" id="nickName"/>
